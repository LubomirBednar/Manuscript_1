...
##### add clean tables
E1_std <- "https://raw.githubusercontent.com/derele/Eimeria_Lab/master/data/3_recordingTables/P3_112019_Eim_FEC_ELISA1_std.csv"
E1_std <- read.csv(text = getURL(E1_std))

E1_samples <- "https://raw.githubusercontent.com/derele/Eimeria_Lab/master/data/3_recordingTables/P3_112019_Eim_FEC_ELISA1_samples.csv"
...
write.csv(E1, "./Eimeria_Lab/data/3_recordingTables/P3_112019_Eim_fecal_ELISAs/P3_112019_Eim_FEC_ELISA1_complete.csv")
